#' extra formula from nomogram
#'
#' @param nomogram nomogram after nomogram command from rms package
#' @param power power after function nomoFormu_points_cat
#'
#' @return a list
#' @export
#' @examples
...
#' nomoFormu_points_get(nomogram = nomo,power = 1)
#' }
nomoFormu_points_get <- function(nomogram,power){
